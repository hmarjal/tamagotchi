...
void mpu9250_get_data(I2C_Handle *i2c, float *ax, float *ay, float *az, float *gx, float *gy, float *gz) {
	...
	//readByte( ACCEL_XOUT_L, 8, rawData[0]);
	readByte( ACCEL_XOUT_H, 14, rawData);
	//readByte( ACCEL_YOUT_L, 8, rawData[2]);
	//readByte( ACCEL_YOUT_H, 8, rawData[3]);
	//readByte( ACCEL_ZOUT_L, 8, rawData[4]);
	//readByte( ACCEL_ZOUT_H, 8, rawData[5]);

	//readByte( GYRO_XOUT_L, 8, rawData[6]);
	//readByte( GYRO_XOUT_H, 8, rawData[7]);
	//readByte( GYRO_YOUT_L, 8, rawData[8]);
	//readByte( GYRO_YOUT_H, 8, rawData[9]);
	//readByte( GYRO_ZOUT_L, 8, rawData[10]);
	//readByte( GYRO_ZOUT_H, 8, rawData[11]);
	...
	// gyro data
	data[4] = (int16_t)(((int16_t)rawData[8] << 8) | rawData[9]);
	data[5] = (int16_t)(((int16_t)rawData[10] << 8) | rawData[11]);
	data[6] = (int16_t)(((int16_t)rawData[12] << 8) | rawData[13]);
